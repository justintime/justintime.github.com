...
footer: true
---
At one of my jobs, we recently went through the process of
selecting a [CDN (Content Delivery
Network)](http://en.wikipedia.org/wiki/Content\_delivery\_network)
...
[CDN](http://drupal.org/project/cdn), this information presented in
...
headers on 99% of our static content as recommended by [Yahoo's
"Best Practices for Speeding Up Your
Website"](https://developer.yahoo.com/performance/rules.html). 
...
to invest in one month's worth of reporting from [CloudHarmony's
CloudReports](http://cloudharmony.com/reports) service.  This gave
...
[Akamai](http://www.akamai.com) 2.
[CacheFly](http://www.cachefly.com) 3.
[EdgeCast](http://www.edgecast.com) 4.
[LimeLight](http://www.limelight.com) \#\#\# First elimination:
...
[Pingdom](http://www.pingdom.com) to download a typical JPEG image
...
![image](/assets/images/cdn.png) \#\#\# Third elimination: CacheFly
